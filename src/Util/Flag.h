...
#ifndef CN_HUST_UTIL_FLAG_H
#define CN_HUST_UTIL_FLAG_H


enum DebugLevel {
    DebugNone,

    DebugFatal, // the program will crash.
    DebugError, // logic errors that can affect effectiveness.
    DebugWarning, // logic errors that can affect efficiency.
    DebugAll,

    GlobalDebugLevel = DebugAll,
};
inline bool debug(DebugLevel level) { return level <= GlobalDebugLevel; }
